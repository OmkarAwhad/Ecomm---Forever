         ...
         <div className="my-20">
            ...
            <div className="flex">
               <div className="border w-[40%] p-20 flex flex-col gap-5">
                  <p className="font-medium text-black">QUALITY ASSURANCE:</p>
               ...
               <div className="border w-[40%] p-20 flex flex-col gap-5">
                  <p className="font-medium text-black">CONVENIENCE</p>
               ...
               <div className="border w-[40%] p-20 flex flex-col gap-5">
                  <p className="font-medium text-black">EXCEPTIONAL CUSTOMER SERVICE:</p>
