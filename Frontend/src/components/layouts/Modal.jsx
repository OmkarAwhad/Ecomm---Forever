				...
				<div className="flex gap-3">
					<button
						...
						className={`flex-1 px-4 py-3 rounded-lg font-medium transition-colors duration-200 ${
							btn1.className ||
							"bg-pink-200 text-black hover:bg-pink-400 hover:text-gray-600 transition-all duration-200"
						}`}
					>
						{btn1.text}
					</button>
					...
					<button
						...
						className={`flex-1 px-4 py-3 rounded-lg font-medium transition-colors duration-200 ${
							btn2.className ||
							"bg-gray-200 text-black hover:bg-gray-400 hover:text-gray-200 transition-all duration-200 "
						}`}
					>
						{btn2.text}
					</button>
