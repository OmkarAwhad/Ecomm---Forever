...
function ProductInOrder({ prodData, getOrderData }) {
	...
	return (
		<div className="py-4 w-[90%] mx-auto border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.2fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4 justify-between ">
			<div className="flex items-start gap-10 ">
				<img
					src={prodData?.product?.images[0]}
					alt="Prod_image"
					className=" h-25 sm:w-20  "
				/>
